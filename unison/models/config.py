...
class Config(models.Model):
    ...
    digitalocean_api = fields.Char('DigitalOcean API Access Token')
    sparkpost_api = fields.Char('SparkPost API Access Token')
    dockerhub_email = fields.Char('Docker Hub Email')
    dockerhub_auth = fields.Char('Docker Hub Auth')
